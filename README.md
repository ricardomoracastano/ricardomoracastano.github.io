...
-->
  ...
  <style>
    body {
      background-image: url(assets/20200704_203459.jpg);
    ...
    <div class="gridContainer clearfix">
      <div id="content"
        ...
        <div class="fluid intro_paragraph">
          <nav>
            <p><a href="homericardo.html"> Home</a> - <a href="about_us.html">About Us</a> - <a
                 href="blogricardo.html">Blog</a> - <a href="contact_usricardo.html">Contact Us</a> - <a
                 href="activitiesricardo.html">Activities at Wake Tech</a></p>
          </nav>

          <p><em style="text-align: justify; font-style: normal; font-size: large;">“Welcome to the real world”
          ...
          <ul>
            <li>
              <p>What are your company's core values?</p>
            </li>
            <li>
              <p>What is the specific purpose of your website?</p>
            </li>
            <li>
              <p>What can visitors do on the website and what can visitors see on the website?</p>
            </li>
            <li>
              <p>&nbsp; Who is your audience? </p>
            </li>
            <li>
              <p>What images or videos do you want for your website?</p>
            </li>
